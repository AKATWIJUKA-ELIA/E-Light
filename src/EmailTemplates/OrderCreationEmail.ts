...
export const newOrderCreationEmailHTML = async (
  Order: OrderItem,
  Seller: User,
  product: Product
) => {
  ...
  const statusConfig = {
    pending: {
      ...
      message: 'You Have  received an order that is pending confirmation.',
    },
    confirmed: {
      color: '#10b981',
      bgColor: '#d1fae5',
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 50%; text-align: right;">
                                                        ...
                                                        <p style="margin: 5px 0 0 0; color: #2c3e50; font-size: 16px; font-weight: bold;">${formatDate(Order._creationTime?Order._creationTime:Date.now())}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
