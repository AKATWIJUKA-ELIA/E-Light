                                ...
                                <div className='flex' >
                                        <div className="hidden lg:flex  bg-white hover:bg-gray-200 transition duration-100 border border-gray-300 rounded-3xl">
                                                ...
                                                <div className='flex rounded-full' >
                                                        <Image src={User?User.profilePicture:""} width={35} height={35} alt='profile picture' className="rounded-full" />
                                                </div>
                                        </div>
                                        {/* For small screens */}
                                        <div className="flex lg:hidden">
                                                <Link href="/sign-in" className='flex ' >
                                                 <Image src={User?User.profilePicture:""} width={100} height={50} alt='profile picture' className="rounded-full" />
                                                </Link>
                                        </div>
