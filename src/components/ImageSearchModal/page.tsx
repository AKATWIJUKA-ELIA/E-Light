...
const ImageSearchModal: React.FC<SearchModel> = ({ onClose,  }) => {
  ...
  return (
        ...
        <div
      className="mx-auto px-5 z-50  fade-in w-72 h-48 gap-4 mt-36 border-2 border-dashed bg-gray-200 border-gray-300 rounded-3xl text-center p-4 cursor-pointer"
